...
<head>
    <meta charset="UTF-8">
    <title>JAVA-SSM 个人博客后台管理 —— 增加分类</title>
...
<div class="back-right">
    ...
    <div class="back-right-left-nav">
        <ul>
            ...
            <li><a href="<c:url value="/jsp/Blog-Back/back-type-add.jsp"/> " id="color-black">增加分类</a></li>
            <li><a href="#">修改分类</a></li>
            <li><a href="#" >分类查询</a></li>
        </ul>
    </div>
    <div class="back-comment">
        ...
        <form method="post" action="<c:url value="/type/insertType.action"/> ">

            <div class="content">
                <input type="text" name="name" value="${name}" placeholder="请输入分类名称...">
            </div>
            <div class="content">
                <input type="text" name="sort" value="${sort}" placeholder="请输入分类排序...">
            </div>
            <div class="footer">
                <button>添加</button>
            </div>
